...
Building netty from source on linux may result in a cryptic failure when building the transport-native-epoll module. Refer to [[Native-transports]] for details.
